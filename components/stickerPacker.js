...
export default function StickerPicker({ onSelect }) {
  return (
    <div id='scrollbar-remove' className="relative w-full flex gap-2 overflow-x-auto p-2 bg-transparent whitespace-nowrap scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent">
