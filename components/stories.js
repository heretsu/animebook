...
const Stories = () => {
  ...
  //       id="stories"
  //       htmlFor="input-file"
  //       className="rounded relative w-[3rem] h-20 overflow-hidden cursor-pointer"
  //     >
  //       {userData !== undefined && (
  //         <Image
  //           src={userData.avatar}
  ...
  //         <div className="font-medium text-2xl self-center w-3 h-6 flex items-center justify-center">
  //           +
  //         </div>
  //         <span className="text-[8px]">New Story</span>
  //       </div>
  ...
  //               <p className="absolute flex flex-row text-xs font-semibold w-full justify-center text-start">
  //                 {story.username}
  //               </p>
  //             </div>
  //           </div>
