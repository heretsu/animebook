      ...
      {userData !== null && userData !== undefined && (
        ...
        >
          ...
          <span className="flex flex-col px-4 w-full space-y-2">
            ...
            <span className="text-start text-sm w-full flex flex-col">
              <span className="flex flex-row space-x-1 font-medium">
                <span>ETH Wallet</span>
                <span className="text-xs ml-2 bg-[#EB4463] text-white py-0.5 px-1 rounded">
              ...
              >
                <span className="bg-transparent border-none focus:ring-0 px-2">
                  {" "}
                  {newAddress ? newAddress : userData.address}
                </span>
                <span
                  onClick={() => {
                    // connectToWallet()
                  ...
                  className="cursor-pointer bg-black text-white px-3 py-2 rounded-r-lg"
                >
                  Change Wallet
                </span>
              </span>
