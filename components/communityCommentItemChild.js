...
export default function CommunityCommentItemChild({ commentChild, setCommentMsg, setParentId }) {
  ...
  return (
    upvotes &&
        ...
        <span className={`bg-transparent ${darkMode ? 'text-white' : 'text-black'} w-11/12 py-2 px-3 rounded-xl flex flex-col justify-center text-start`}>
          <span className="flex flex-row justify-between items-center">
            ...
            >
              <span className="relative h-6 w-6 flex">
                <Image
                  src={imgSrc}
                  alt="user profile"
                  width={30}
                    ...
                    <g id="up-arrow" transform="translate(0)">
                      ...
                      >
                        <path
                          ...
                          fill={upvoted ? "#EB4463" : darkMode ? "#42494F" : "#adb6c3"}
                        />
                      </g>
                    </g>
                  </svg>

                  <div className={`py-0.5 px-2 text-sm font-normal rounded text-[#728198] ${darkMode ? 'text-[#AFB1B2] bg-[#292C33]' : 'text-[#728198] bg-[#F5F5F5]'}`}>
                    {upvotes.length}
                  </div>
