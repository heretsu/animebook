...
export const PreviewAsset = ()=>{
  const {darkMode} = useContext(UserContext);

  return <span className="px-0.5">
    <svg
  width="20"
  height="20"
  viewBox="0 0 24 24"
                          ...
                          return (
                            ...
                            >
                              <span
                                ...
                                className="flex lg:hidden h-11 w-11 flex-shrink-0"
                              >
                                <Image
                                  src={
                                    getUserFromId(
                              ...
                              <span
                                ...
                                className="hidden lg:flex h-11 w-11 flex-shrink-0"
                              >
                                <Image
                                  src={
                                    getUserFromId(
